...
const TopicRow: React.FC<TopicRowProps> = ({
  ...
  return (
    <Fragment>
      <tr className={`border-b border-gray-200 dark:border-gray-700 ${isGroupingTopic ? 'bg-gray-50 dark:bg-gray-800/50' : (topic.is_completed ? 'bg-green-50 dark:bg-green-900/50' : 'bg-white dark:bg-gray-800')}`}>
        <td className="p-2 dark:text-gray-100" style={{ paddingLeft: `${level * 20 + 8}px` }}>
          <div className="flex items-center">
            ...
            <input
              ...
              className={`mr-2 h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 ${isGroupingTopic ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}`}
